    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonConcrete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bagsRequired = Math.Ceiling(cementRequired / bag_weight);
                totalCost = (decimal)bagsRequired * bag_cost;

                // display output values
                textBoxConcreteRequired.Text = concreteRequired.ToString("N3");
                textBoxCementRequired.Text = cementRequired.ToString("N3");
            ...
            {
                MessageBox.Show("Error. Have you added values to Driveway Length and Width?");
